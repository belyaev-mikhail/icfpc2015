You need Mono and F# under Linux to build this.
The rest should be smooth.

There is the VS2015 project available to look at on Windows.
...
Sincerely yours, Mikhail Belyaev aka team Summerscream)